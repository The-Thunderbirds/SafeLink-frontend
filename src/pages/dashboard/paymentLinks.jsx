        ...
        <div className="m-4 flex flex-wrap ">
          <div className="w-7/12  md:w-1/2 mt-15">
            ...
            <form className="mt-5 mb-2 mx-2 w-11/12 mr-3 max-w-screen">
              ...
              />
              <Button className="mt-6" fullWidth onClick={createPaymentRequest}>
                Create Payment Link
              </Button>
          ...
          <Card color="transparent" shadow={false} className="px-4 max-h-60 w-full" style={{ marginTop: "20vh", marginLeft: "2.5%", maxWidth: "45%", background: "radial-gradient( circle 877px at 1% 82.3%, rgb(55, 60, 245) 2%, rgba(234,161,15,0.90) 101.2% )" }}>
            ...
            <CardFooter>
              <div className="flex items-center justify-between">
                <div className="flex flex-col items-left -ml-5"><Typography variant="h6" className="" color="white">From </Typography><div className="flex items-center gap-1"> <Typography variant="h5" color="white">{userInfo?.name} </Typography><ArrowUpRightIcon height={20} width={20} color="white" /> </div></div>
                <Typography variant="h6" className="-mb-10" color="white">SafeLink</Typography>
              </div>
